...
public class SynedriaKrathsh {
	...
	protected void createContents() {
		...
		btnNewButton_5.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				shell.dispose();
	    		SynedriaMynhma mynhma = new SynedriaMynhma();
	    		mynhma.open();
			}
		});
		...
		Text txtPhexnet = new Text(shell, SWT.NONE);
		txtPhexnet.setText(Synedria.kr.get(2));
		txtPhexnet.setBounds(342, 153, 72, 21);
		
		Text text_2 = new Text(shell, SWT.NONE);
		text_2.setText(Synedria.kr.get(3));
		text_2.setBounds(452, 153, 68, 21);
		
		Text text_3 = new Text(shell, SWT.NONE);
		text_3.setText(Synedria.kr.get(1));
		text_3.setBounds(550, 153, 76, 21);
		...
		text_4.setBounds(646, 150, 76, 21);
		text_4.setText("ΣΦΕΕ");
