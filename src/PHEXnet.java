...
public class PHEXnet {
	...
	protected void createContents() {
		...
		Table table = new Table(shell, SWT.CHECK | SWT.BORDER | SWT.V_SCROLL
		    ...
		    String[] titles = {"Σεμηνάρια/Συνέδρια", "Τοποθεσία", "Ημερομηνία Διεξαγωγής", "Ώρα"};
		    ...
		    lblNewLabel.setBounds(193, 93, 179, 25);
		    lblNewLabel.setText("\u0395\u03BD\u03B7\u03BC\u03AD\u03C1\u03C9\u03C3\u03B7 \u03B3\u03B9\u03B1 PHEXnet");
		    ...
		    button_4.addSelectionListener(new SelectionAdapter() {
		    	...
		    	public void widgetSelected(SelectionEvent e) {
		    		...
		    		if (flag!=1)
		    		{
			    			MynhmaKrathshs2 mynhmak2 = new MynhmaKrathshs2();
			    			mynhmak2.open();
		    		}
		    		else {
			    		PHEXnetKrathsh mynhma = new PHEXnetKrathsh();
			    		mynhma.open();
		    		}
		    	}
		    });
