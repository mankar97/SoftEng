...
public class Synedria {
	...
	public static ArrayList<String> kr = new ArrayList<String>();

	private static String[][] ssReq() {
		return retSSList();
	}
	private static String[][] retSSList() {
		String[][] ssList = new String[20][4];
		for (int loopIndex = 0; loopIndex < 20; loopIndex++) {
			ssList[loopIndex][0] = "Σεμινάριο" + loopIndex;
			ssList[loopIndex][1] = "Πάτρα";
			ssList[loopIndex][2] = "01/01/2020";
			ssList[loopIndex][3] = "10:00 πμ";		      
		}
		return ssList;
	}
	...
	protected void createContents() {
		...
		Table table = new Table(shell, SWT.CHECK | SWT.BORDER | SWT.V_SCROLL
		    ...
		    String[] titles = {"Σεμινάρια/Συνέδρια", "Τοποθεσία", "Ημερομηνία Διεξαγωγής", "Ώρα"};
		    ...
		    for (int loopIndex = 0; loopIndex < 20; loopIndex++) {
		      ...
		      item.setText(0, ssList[loopIndex][0]);
		      item.setText(1, ssList[loopIndex][1]);
		      item.setText(2, ssList[loopIndex][2]);
		      item.setText(3, ssList[loopIndex][3]);
		    ...
		    table.setBounds(194, 124, 434, 216);
		    
		    Label lblNewLabel = new Label(shell, SWT.NONE);
		    lblNewLabel.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
		    lblNewLabel.setFont(SWTResourceManager.getFont("Segoe UI", 11, SWT.BOLD));
		    lblNewLabel.setBounds(193, 93, 157, 25);
		    lblNewLabel.setText("\u03A3\u03B5\u03BC\u03B9\u03BD\u03AC\u03C1\u03B9\u03B1/\u03A3\u03C5\u03BD\u03AD\u03B4\u03C1\u03B9\u03B1");
		    ...
		    button_4.addSelectionListener(new SelectionAdapter() {
		    	...
		    	public void widgetSelected(SelectionEvent e) {
		    		...
		    		Synedria.kr.clear();
		    		for(int i=0;i<4;i++) {
		    			Synedria.kr.add(table.getItem(brethike).getText(i));
		    		}
		    		shell.dispose();
		    		if (flag!=1)
		    		{
			    			MynhmaKrathshs mynhmak = new MynhmaKrathshs();
			    			mynhmak.open();
		    		}
		    		else {
	    				SynedriaKrathsh synkra=new SynedriaKrathsh();
	    				synkra.open();
		    		}
		    	}
		    });
		    button_4.setBounds(685, 308, 89, 32);
		    button_4.setText("\u039A\u03C1\u03AC\u03C4\u03B7\u03C3\u03B7");
		    button_4.setBackground(SWTResourceManager.getColor(153, 255, 153));
			...
			lblNewLabel_7.setFont(SWTResourceManager.getFont("Segoe UI", 8, SWT.NORMAL));
			lblNewLabel_7.setBounds(173, 397, 26, 15);
