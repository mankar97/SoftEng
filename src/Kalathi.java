...
public class Kalathi {
	...
	public static ArrayList<Proion> bucket = new ArrayList<Proion>();
	protected Shell shell;
	private Text text;
	private Text txtUsername;
	private double doublesinolo=0;
	...
	protected void createContents() {
		...
		Table table = new Table(shell, SWT.BORDER | SWT.V_SCROLL
		    ...
		    String[] titles = {"Όνομα Προϊόντος", "€/Τεμάχιο", "Ποσότητα", "Τιμή", };
		    ...
		    for (int loopIndex = 0; loopIndex < Diathesima.diathbrethike.size(); loopIndex++) {
		    			
		    			Kalathi.bucket.add(NeaPwlhsh.ListaPwlisisPr.get(Diathesima.diathbrethike.get(loopIndex)));
		    			TableItem item = new TableItem(table, SWT.NULL);
		    			item.setText(0, NeaPwlhsh.ListaPwlisisPr.get(Diathesima.diathbrethike.get(loopIndex)).getnamePr());
		    			item.setText(1, Double.toString(NeaPwlhsh.ListaPwlisisPr.get(Diathesima.diathbrethike.get(loopIndex)).getprice()));
		    			item.setText(2, Integer.toString(NeaPwlhsh.ListaPwlisisPr.get(Diathesima.diathbrethike.get(loopIndex)).getquantitySell()));
		    			double sinolo=NeaPwlhsh.ListaPwlisisPr.get(Diathesima.diathbrethike.get(loopIndex)).getprice()*NeaPwlhsh.ListaPwlisisPr.get(loopIndex).getquantitySell();
		    			doublesinolo+=sinolo;
		    			item.setText(3, Double.toString(sinolo));
		    ...
		    table.setBounds(173, 100, 314, 240);
		    
		    Label label = new Label(shell, SWT.NONE);
		    label.setFont(SWTResourceManager.getFont("Segoe UI", 11, SWT.BOLD));
		    label.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
		    label.setBounds(520, 123, 131, 57);
		    label.setText("\u03A3\u03C5\u03BD\u03BF\u03BB\u03B9\u03BA\u03CC \u039A\u03CC\u03C3\u03C4\u03BF\u03C2:");
		    
		    Label lblNewLabel = new Label(shell, SWT.NONE);
		    lblNewLabel.setFont(SWTResourceManager.getFont("Segoe UI", 11, SWT.BOLD));
		    lblNewLabel.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
		    lblNewLabel.setBounds(657, 123, 117, 21);
		    lblNewLabel.setText(Double.toString(doublesinolo) + "€");
		    ...
		    button_4.addSelectionListener(new SelectionAdapter() {
		    	...
		    	public void widgetSelected(SelectionEvent e) {
		    		shell.dispose();
		    		Synallagh agora=new Synallagh();
		    		agora.open();
		    	}
		    });
		    button_4.setFont(SWTResourceManager.getFont("Segoe UI", 11, SWT.NORMAL));
		    button_4.setBounds(602, 267, 75, 25);
		    button_4.setText("\u03A3\u03C5\u03BD\u03AD\u03C7\u03B5\u03B9\u03B1");
			...
			button_5.setText("\u0386\u03B4\u03B5\u03B9\u03B1\u03C3\u03BC\u03B1 \u039A\u03B1\u03BB\u03B1\u03B8\u03B9\u03BF\u03CD");
			button_5.setForeground(SWTResourceManager.getColor(SWT.COLOR_MAGENTA));
			button_5.setFont(SWTResourceManager.getFont("Segoe UI", 10, SWT.NORMAL));
			button_5.setBackground(SWTResourceManager.getColor(255, 255, 255));
			button_5.setBounds(580, 389, 127, 25);
