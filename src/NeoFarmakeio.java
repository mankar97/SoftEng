...
public class NeoFarmakeio {
	...
	protected void createContents() {
		...
		btnPhxnet.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				shell.dispose();
				NeoFarmakeio test8=new NeoFarmakeio();
				test8.open();
			}
		});
		...
		btnNewButton_6.setBounds(567, 4, 26, 25);
			...
			table.setBounds(238, 155, 157, 65);
			
			TableItem tableItem = new TableItem(table, SWT.NONE);
			tableItem.setFont(SWTResourceManager.getFont("Segoe UI", 10, SWT.BOLD));
			tableItem.setText("\u038C\u03BD\u03BF\u03BC\u03B1 \u03A6\u03B1\u03C1\u03BC\u03B1\u03BA\u03BF\u03C0\u03BF\u03B9\u03BF\u03CD");
			
			TableItem tableItem_1 = new TableItem(table, SWT.NONE);
			tableItem_1.setFont(SWTResourceManager.getFont("Segoe UI", 10, SWT.BOLD));
			tableItem_1.setText("\u03A4\u03BF\u03C0\u03BF\u03B8\u03B5\u03C3\u03AF\u03B1");
			
			TableItem tableItem_2 = new TableItem(table, SWT.NONE);
			tableItem_2.setFont(SWTResourceManager.getFont("Segoe UI", 10, SWT.BOLD));
			tableItem_2.setText("\u0394\u03B9\u03B5\u03CD\u03B8\u03C5\u03BD\u03C3\u03B7");
			
			text_1 = new Text(shell, SWT.BORDER);
			text_1.setBounds(430, 155, 233, 21);
			
			text_2 = new Text(shell, SWT.BORDER);
			text_2.setBounds(430, 176, 233, 21);
			
			text_3 = new Text(shell, SWT.BORDER);
			text_3.setBounds(430, 197, 233, 21);
			
			Button btnNewButton_5 = new Button(shell, SWT.NONE);
			btnNewButton_5.setForeground(SWTResourceManager.getColor(SWT.COLOR_BLUE));
			btnNewButton_5.addSelectionListener(new SelectionAdapter() {
				@Override
				public void widgetSelected(SelectionEvent e) {
					shell.dispose();
					Protash pr = new Protash();
					pr.open();
				}
			});
			btnNewButton_5.setBounds(532, 283, 131, 25);
			btnNewButton_5.setText("\u0391\u03C0\u03BF\u03C3\u03C4\u03BF\u03BB\u03AE \u03A0\u03C1\u03CC\u03C4\u03B1\u03C3\u03B7\u03C2");
