...
public class Diathesima{

	protected Shell shell;
	private Text text;
	private Text txtUsername;
	private Table table;
	public static ArrayList<Integer> diathbrethike = new ArrayList<Integer>();
	...
	protected void createContents() {
		...
		button.setBackground(SWTResourceManager.getColor(102, 153, 255));
	    ...
	    String[] titles = { "Όνομα Προϊόντος", "Κωδικός Προϊόντος" ,"Τιμή Προϊόντος","Ποσότητα","Τοποθεσία Φαρμακείου", "Ημερομηνία Λήξης" };

	    for (int loopIndex = 0; loopIndex < titles.length; loopIndex++) {
	      TableColumn column = new TableColumn(table, SWT.NULL);
	      column.setText(titles[loopIndex]);
	    }
	    String[][] slist = AggeliaPwlisis.saleReq();
	    for (int loopIndex = 0; loopIndex < NeaPwlhsh.ListaPwlisisPr.size(); loopIndex++)
	    {
	    	TableItem item = new TableItem(table, SWT.NULL);
	    	item.setText(0, slist[loopIndex][0]);
	    	item.setText(1, slist[loopIndex][1]);
	    	item.setText(2, slist[loopIndex][2]);
	    	item.setText(3, slist[loopIndex][3]);
	    	item.setText(4, slist[loopIndex][4]);
		   	item.setText(5, slist[loopIndex][5]);
	    }
	    ...
	    table.setBounds(173, 100, 661, 240);
		...
		btnNewButton_7.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				{
					shell.dispose();
	                MynhmaAporripshs2 ma2=new MynhmaAporripshs2();
	                ma2.open();
				}
				else
				{
		...
		btnNewButton_7.setBounds(702, 346, 132, 25);
		btnNewButton_7.setText("\u03A0\u03C1\u03BF\u03C3\u03B8\u03AE\u03BA\u03B7 \u03C3\u03C4\u03BF \u03BA\u03B1\u03BB\u03AC\u03B8\u03B9");
